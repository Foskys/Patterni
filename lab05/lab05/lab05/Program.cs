...
namespace Lab05
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                IWriter writer = new FileWriter(@"D:\later github\PP\lab05\test2.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"D:\later github\PP\lab05\test4.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"D:\later github\PP\lab05\test12.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
                string? result = hash.Save("BBBBCCCCC");
            ...
            {
                IWriter writer = new FileWriter(@"D:\later github\PP\lab05\test13.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
                string? result = hash.Save("BBBBCCCCC");
